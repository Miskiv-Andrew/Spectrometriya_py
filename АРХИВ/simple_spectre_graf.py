...
class Ui_Form(object):
    ...
    def setupUi(self, Form):
        ...
        self.textEdit_left_info = QtWidgets.QTextEdit(Form)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Minimum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.textEdit_left_info.sizePolicy().hasHeightForWidth())
        self.textEdit_left_info.setSizePolicy(sizePolicy)
        self.textEdit_left_info.setObjectName("textEdit_left_info")
        self.gridLayout_3.addWidget(self.textEdit_left_info, 0, 0, 1, 1)
        self.horizontalLayout.addLayout(self.gridLayout_3)
        self.gridLayout_4 = QtWidgets.QGridLayout()
        self.gridLayout_4.setObjectName("gridLayout_4")
        self.textEdit_right_info = QtWidgets.QTextEdit(Form)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Minimum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.textEdit_right_info.sizePolicy().hasHeightForWidth())
        self.textEdit_right_info.setSizePolicy(sizePolicy)
        self.textEdit_right_info.setObjectName("textEdit_right_info")
        self.gridLayout_4.addWidget(self.textEdit_right_info, 0, 0, 1, 1)
